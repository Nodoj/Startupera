    ...
    <section id="team" className="py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Our diverse team of AI specialists, engineers, and strategists brings together decades of experience in artificial intelligence, automation, and secure enterprise solutions."
          center
          mb="80px"
        />
...
const SingleTeamMember = ({ member }: { member: TeamMember }) => {
  const { name, position, description, image, socialLinks } = member;

  return (
    <div className="group relative overflow-hidden rounded-lg bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-dark">
      {/* Profile Image */}
