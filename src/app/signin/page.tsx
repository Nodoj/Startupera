...
const SigninPage = ({ searchParams }: { searchParams: Promise<{ message?: string; error?: string }> }) => {
            ...
            <div className="w-full px-4">
              <div className="shadow-three dark:bg-dark mx-auto max-w-[500px] rounded-sm bg-white px-6 py-10 sm:p-[60px]">
                ...
                <p className="text-body-color mb-11 text-center text-base font-medium">
                  Access your admin panel to manage AI automation flows.
                </p>
                  ...
                  <div className="mb-8 flex flex-col justify-between sm:flex-row sm:items-center">
                    <div className="mb-4 sm:mb-0">
                      <label
                        ...
                        className="text-body-color cursor-pointer text-sm font-medium select-none"
                      >
                        <div className="flex items-center">
                          <div className="relative">
                            <input
                              ...
                              onChange={(e) => setIsKeepSignedIn(e.target.checked)}
                              className="sr-only"
                            />
                            <div className="box border-body-color/20 mr-4 flex h-5 w-5 items-center justify-center rounded-sm border dark:border-white/10">
                              <span className={isKeepSignedIn ? "opacity-100" : "opacity-0"}>
                                <svg
                                  width="11"
                                  height="8"
                                  viewBox="0 0 11 8"
